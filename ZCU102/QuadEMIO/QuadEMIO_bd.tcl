...
################################################################
# This is a generated script based on design: QuadEMIO
#
...
if { ${design_name} eq "" } {
  ...
  set_property USER_COMMENTS.comment_1 "PS-EMIO QUAD 1000BASE-X" [get_bd_designs $design_name]
...
proc create_root_design { parentCell } {
  ...
  set sfp1 [ create_bd_intf_port -mode Master -vlnv xilinx.com:interface:sfp_rtl:1.0 sfp1 ]
  set sfp2 [ create_bd_intf_port -mode Master -vlnv xilinx.com:interface:sfp_rtl:1.0 sfp2 ]
  set sfp3 [ create_bd_intf_port -mode Master -vlnv xilinx.com:interface:sfp_rtl:1.0 sfp3 ]
  ...
  set sfp_tx_dis1 [ create_bd_port -dir O -from 0 -to 0 sfp_tx_dis1 ]
  set sfp_tx_dis2 [ create_bd_port -dir O -from 0 -to 0 sfp_tx_dis2 ]
  set sfp_tx_dis3 [ create_bd_port -dir O -from 0 -to 0 sfp_tx_dis3 ]
  ...
  set gig_ethernet_pcs_pma_1 [ create_bd_cell -type ip -vlnv xilinx.com:ip:gig_ethernet_pcs_pma:16.1 gig_ethernet_pcs_pma_1 ]
  set_property -dict [ list \
   CONFIG.DIFFCLK_BOARD_INTERFACE {Custom} \
   CONFIG.EMAC_IF_TEMAC {GEM} \
   CONFIG.GT_Location {X0Y13} \
   CONFIG.RefClkRate {156.25} \
   CONFIG.SupportLevel {Include_Shared_Logic_in_Example_Design} \
   CONFIG.USE_BOARD_FLOW {true} \
 ] $gig_ethernet_pcs_pma_1

  # Create instance: gig_ethernet_pcs_pma_2, and set properties
  set gig_ethernet_pcs_pma_2 [ create_bd_cell -type ip -vlnv xilinx.com:ip:gig_ethernet_pcs_pma:16.1 gig_ethernet_pcs_pma_2 ]
  set_property -dict [ list \
   CONFIG.DIFFCLK_BOARD_INTERFACE {Custom} \
   CONFIG.EMAC_IF_TEMAC {GEM} \
   CONFIG.GT_Location {X0Y14} \
   CONFIG.RefClkRate {156.25} \
   CONFIG.SupportLevel {Include_Shared_Logic_in_Example_Design} \
   CONFIG.USE_BOARD_FLOW {true} \
 ] $gig_ethernet_pcs_pma_2

  # Create instance: gig_ethernet_pcs_pma_3, and set properties
  set gig_ethernet_pcs_pma_3 [ create_bd_cell -type ip -vlnv xilinx.com:ip:gig_ethernet_pcs_pma:16.1 gig_ethernet_pcs_pma_3 ]
  set_property -dict [ list \
   CONFIG.DIFFCLK_BOARD_INTERFACE {Custom} \
   CONFIG.EMAC_IF_TEMAC {GEM} \
   CONFIG.GT_Location {X0Y15} \
   CONFIG.RefClkRate {156.25} \
   CONFIG.SupportLevel {Include_Shared_Logic_in_Example_Design} \
   CONFIG.USE_BOARD_FLOW {true} \
 ] $gig_ethernet_pcs_pma_3
  ...
  set_property -dict [ list \
   ...
   CONFIG.PSU_MIO_TREE_PERIPHERALS {######TTC 0#TTC 0#######I2C 0#I2C 0#I2C 1#I2C 1#UART 0#UART 0#UART 1#UART 1##################SD 1#SD 1#SD 1#SD 1#SD 1#SD 1#SD 1#SD 1#SD 1#SD 1#SD 1#SD 1#SD 1##########################} \
   CONFIG.PSU_MIO_TREE_SIGNALS {######clk_in#wave_out#######scl_out#sda_out#scl_out#sda_out#rxd#txd#txd#rxd##################sdio1_data_out[4]#sdio1_data_out[5]#sdio1_data_out[6]#sdio1_data_out[7]#sdio1_bus_pow#sdio1_wp#sdio1_cd_n#sdio1_data_out[0]#sdio1_data_out[1]#sdio1_data_out[2]#sdio1_data_out[3]#sdio1_cmd_out#sdio1_clk_out##########################} \
   ...
   CONFIG.PSU__CRF_APB__DPDMA_REF_CTRL__ACT_FREQMHZ {549.994500} \
   ...
   CONFIG.PSU__CRF_APB__GDMA_REF_CTRL__ACT_FREQMHZ {549.994500} \
   ...
   CONFIG.PSU__CRF_APB__TOPSW_MAIN_CTRL__ACT_FREQMHZ {474.995250} \
   ...
   CONFIG.PSU__CRL_APB__GEM2_REF_CTRL__ACT_FREQMHZ {124.998750} \
   ...
   CONFIG.PSU__PROTECTION__MASTERS {USB1:NonSecure;0|USB0:NonSecure;0|S_AXI_LPD:NA;0|S_AXI_HPC1_FPD:NA;0|S_AXI_HPC0_FPD:NA;0|S_AXI_HP3_FPD:NA;0|S_AXI_HP2_FPD:NA;0|S_AXI_HP1_FPD:NA;0|S_AXI_HP0_FPD:NA;0|S_AXI_ACP:NA;0|S_AXI_ACE:NA;0|SD1:NonSecure;1|SD0:NonSecure;0|SATA1:NonSecure;0|SATA0:NonSecure;0|RPU1:Secure;1|RPU0:Secure;1|QSPI:NonSecure;0|PMU:NA;1|PCIe:NonSecure;0|NAND:NonSecure;0|LDMA:NonSecure;1|GPU:NonSecure;1|GEM3:NonSecure;1|GEM2:NonSecure;1|GEM1:NonSecure;1|GEM0:NonSecure;1|FDMA:NonSecure;1|DP:NonSecure;0|DAP:NA;1|Coresight:NA;1|CSU:NA;1|APU:NA;1} \
  ...
  connect_bd_intf_net -intf_net gig_ethernet_pcs_pma_0_sfp [get_bd_intf_ports sfp0] [get_bd_intf_pins gig_ethernet_pcs_pma_0/sfp]
  connect_bd_intf_net -intf_net gig_ethernet_pcs_pma_1_sfp [get_bd_intf_ports sfp1] [get_bd_intf_pins gig_ethernet_pcs_pma_1/sfp]
  connect_bd_intf_net -intf_net gig_ethernet_pcs_pma_2_sfp [get_bd_intf_ports sfp2] [get_bd_intf_pins gig_ethernet_pcs_pma_2/sfp]
  connect_bd_intf_net -intf_net gig_ethernet_pcs_pma_3_sfp [get_bd_intf_ports sfp3] [get_bd_intf_pins gig_ethernet_pcs_pma_3/sfp]
  ...
  connect_bd_intf_net -intf_net zynq_ultra_ps_e_0_GMII_ENET1 [get_bd_intf_pins gig_ethernet_pcs_pma_1/gmii_gem_pcs_pma] [get_bd_intf_pins zynq_ultra_ps_e_0/GMII_ENET1]
  connect_bd_intf_net -intf_net zynq_ultra_ps_e_0_GMII_ENET2 [get_bd_intf_pins gig_ethernet_pcs_pma_2/gmii_gem_pcs_pma] [get_bd_intf_pins zynq_ultra_ps_e_0/GMII_ENET2]
  connect_bd_intf_net -intf_net zynq_ultra_ps_e_0_GMII_ENET3 [get_bd_intf_pins gig_ethernet_pcs_pma_3/gmii_gem_pcs_pma] [get_bd_intf_pins zynq_ultra_ps_e_0/GMII_ENET3]
  ...
  connect_bd_intf_net -intf_net zynq_ultra_ps_e_0_MDIO_ENET1 [get_bd_intf_pins gig_ethernet_pcs_pma_1/mdio_pcs_pma] [get_bd_intf_pins zynq_ultra_ps_e_0/MDIO_ENET1]
  connect_bd_intf_net -intf_net zynq_ultra_ps_e_0_MDIO_ENET2 [get_bd_intf_pins gig_ethernet_pcs_pma_2/mdio_pcs_pma] [get_bd_intf_pins zynq_ultra_ps_e_0/MDIO_ENET2]
  connect_bd_intf_net -intf_net zynq_ultra_ps_e_0_MDIO_ENET3 [get_bd_intf_pins gig_ethernet_pcs_pma_3/mdio_pcs_pma] [get_bd_intf_pins zynq_ultra_ps_e_0/MDIO_ENET3]

  # Create port connections
  connect_bd_net -net Net [get_bd_pins constants/config_valid] [get_bd_pins gig_ethernet_pcs_pma_0/an_adv_config_val] [get_bd_pins gig_ethernet_pcs_pma_0/an_restart_config] [get_bd_pins gig_ethernet_pcs_pma_0/configuration_valid] [get_bd_pins gig_ethernet_pcs_pma_1/an_adv_config_val] [get_bd_pins gig_ethernet_pcs_pma_1/an_restart_config] [get_bd_pins gig_ethernet_pcs_pma_1/configuration_valid] [get_bd_pins gig_ethernet_pcs_pma_2/an_adv_config_val] [get_bd_pins gig_ethernet_pcs_pma_2/an_restart_config] [get_bd_pins gig_ethernet_pcs_pma_2/configuration_valid] [get_bd_pins gig_ethernet_pcs_pma_3/an_adv_config_val] [get_bd_pins gig_ethernet_pcs_pma_3/an_restart_config] [get_bd_pins gig_ethernet_pcs_pma_3/configuration_valid]
  ...
  connect_bd_net -net gig_ethernet_pcs_pma_0_gtrefclk_out [get_bd_pins gig_ethernet_pcs_pma_0/gtrefclk_out] [get_bd_pins gig_ethernet_pcs_pma_1/gtrefclk] [get_bd_pins gig_ethernet_pcs_pma_2/gtrefclk] [get_bd_pins gig_ethernet_pcs_pma_3/gtrefclk]
  connect_bd_net -net gig_ethernet_pcs_pma_0_mmcm_locked_out [get_bd_pins gig_ethernet_pcs_pma_0/mmcm_locked_out] [get_bd_pins gig_ethernet_pcs_pma_1/mmcm_locked] [get_bd_pins gig_ethernet_pcs_pma_2/mmcm_locked] [get_bd_pins gig_ethernet_pcs_pma_3/mmcm_locked]
  connect_bd_net -net gig_ethernet_pcs_pma_0_pma_reset_out [get_bd_pins gig_ethernet_pcs_pma_0/pma_reset_out] [get_bd_pins gig_ethernet_pcs_pma_1/pma_reset] [get_bd_pins gig_ethernet_pcs_pma_2/pma_reset] [get_bd_pins gig_ethernet_pcs_pma_3/pma_reset]
  ...
  connect_bd_net -net gig_ethernet_pcs_pma_0_rxuserclk2_out [get_bd_pins gig_ethernet_pcs_pma_0/rxuserclk2_out] [get_bd_pins gig_ethernet_pcs_pma_1/rxuserclk2] [get_bd_pins gig_ethernet_pcs_pma_2/rxuserclk2] [get_bd_pins gig_ethernet_pcs_pma_3/rxuserclk2]
  connect_bd_net -net gig_ethernet_pcs_pma_0_rxuserclk_out [get_bd_pins gig_ethernet_pcs_pma_0/rxuserclk_out] [get_bd_pins gig_ethernet_pcs_pma_1/rxuserclk] [get_bd_pins gig_ethernet_pcs_pma_2/rxuserclk] [get_bd_pins gig_ethernet_pcs_pma_3/rxuserclk]
  ...
  connect_bd_net -net gig_ethernet_pcs_pma_0_userclk2_out [get_bd_pins c_counter_binary_0/CLK] [get_bd_pins gig_ethernet_pcs_pma_0/userclk2_out] [get_bd_pins gig_ethernet_pcs_pma_1/userclk2] [get_bd_pins gig_ethernet_pcs_pma_2/userclk2] [get_bd_pins gig_ethernet_pcs_pma_3/userclk2]
  connect_bd_net -net gig_ethernet_pcs_pma_0_userclk_out [get_bd_pins gig_ethernet_pcs_pma_0/userclk_out] [get_bd_pins gig_ethernet_pcs_pma_1/userclk] [get_bd_pins gig_ethernet_pcs_pma_2/userclk] [get_bd_pins gig_ethernet_pcs_pma_3/userclk]
  connect_bd_net -net xlconstant_0_dout [get_bd_pins constants/phy_addr] [get_bd_pins gig_ethernet_pcs_pma_0/phyaddr]
  connect_bd_net -net xlconstant_0_dout1 [get_bd_ports pl_reset_led] [get_bd_pins gig_ethernet_pcs_pma_0/reset] [get_bd_pins gig_ethernet_pcs_pma_1/reset] [get_bd_pins gig_ethernet_pcs_pma_2/reset] [get_bd_pins gig_ethernet_pcs_pma_3/reset] [get_bd_pins xlconstant_0/dout]
  connect_bd_net -net xlconstant_1_dout [get_bd_pins gig_ethernet_pcs_pma_2/phyaddr] [get_bd_pins xlconstant_1/dout]
  connect_bd_net -net xlconstant_2_dout [get_bd_pins constants/config_vector] [get_bd_pins gig_ethernet_pcs_pma_0/configuration_vector] [get_bd_pins gig_ethernet_pcs_pma_1/configuration_vector] [get_bd_pins gig_ethernet_pcs_pma_2/configuration_vector] [get_bd_pins gig_ethernet_pcs_pma_3/configuration_vector]
  connect_bd_net -net xlconstant_2_dout1 [get_bd_pins gig_ethernet_pcs_pma_1/phyaddr] [get_bd_pins xlconstant_2/dout]
  connect_bd_net -net xlconstant_3_dout [get_bd_pins constants/an_adv_config_vec] [get_bd_pins gig_ethernet_pcs_pma_0/an_adv_config_vector] [get_bd_pins gig_ethernet_pcs_pma_1/an_adv_config_vector] [get_bd_pins gig_ethernet_pcs_pma_2/an_adv_config_vector] [get_bd_pins gig_ethernet_pcs_pma_3/an_adv_config_vector]
  connect_bd_net -net xlconstant_3_dout1 [get_bd_pins gig_ethernet_pcs_pma_3/phyaddr] [get_bd_pins xlconstant_3/dout]
  connect_bd_net -net xlconstant_4_dout [get_bd_pins constants/signal_detect] [get_bd_pins gig_ethernet_pcs_pma_0/signal_detect] [get_bd_pins gig_ethernet_pcs_pma_1/signal_detect] [get_bd_pins gig_ethernet_pcs_pma_2/signal_detect] [get_bd_pins gig_ethernet_pcs_pma_3/signal_detect]
  connect_bd_net -net xlconstant_4_dout1 [get_bd_pins xlconstant_4/dout] [get_bd_pins zynq_ultra_ps_e_0/emio_enet0_tsu_inc_ctrl] [get_bd_pins zynq_ultra_ps_e_0/emio_enet1_tsu_inc_ctrl] [get_bd_pins zynq_ultra_ps_e_0/emio_enet2_tsu_inc_ctrl] [get_bd_pins zynq_ultra_ps_e_0/emio_enet3_tsu_inc_ctrl]
  connect_bd_net -net xlconstant_5_dout [get_bd_ports sfp_tx_dis] [get_bd_ports sfp_tx_dis1] [get_bd_ports sfp_tx_dis2] [get_bd_ports sfp_tx_dis3] [get_bd_pins constants/sfp_tx_dis]
  ...
  connect_bd_net -net zynq_ultra_ps_e_0_pl_clk0 [get_bd_pins gig_ethernet_pcs_pma_0/independent_clock_bufg] [get_bd_pins gig_ethernet_pcs_pma_1/independent_clock_bufg] [get_bd_pins gig_ethernet_pcs_pma_2/independent_clock_bufg] [get_bd_pins gig_ethernet_pcs_pma_3/independent_clock_bufg] [get_bd_pins zynq_ultra_ps_e_0/pl_clk0]
