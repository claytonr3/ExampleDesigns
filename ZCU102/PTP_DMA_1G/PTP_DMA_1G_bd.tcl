...
proc create_hier_cell_zynq_ps { parentCell nameHier } {
  ...
  set_property -dict [ list \
   ...
   CONFIG.PSU__CRL_APB__PL0_REF_CTRL__ACT_FREQMHZ {124.987500} \
   CONFIG.PSU__CRL_APB__PL0_REF_CTRL__DIVISOR0 {12} \
   CONFIG.PSU__CRL_APB__PL0_REF_CTRL__DIVISOR1 {1} \
   CONFIG.PSU__CRL_APB__PL0_REF_CTRL__FREQMHZ {125} \
   CONFIG.PSU__CRL_APB__PL0_REF_CTRL__SRCSEL {IOPLL} \
   CONFIG.PSU__CRL_APB__PL1_REF_CTRL__ACT_FREQMHZ {49.995000} \
   ...
   CONFIG.PSU__PROTECTION__MASTERS {USB1:NonSecure;0|USB0:NonSecure;1|S_AXI_LPD:NA;0|S_AXI_HPC1_FPD:NA;0|S_AXI_HPC0_FPD:NA;1|S_AXI_HP3_FPD:NA;0|S_AXI_HP2_FPD:NA;0|S_AXI_HP1_FPD:NA;0|S_AXI_HP0_FPD:NA;0|S_AXI_ACP:NA;0|S_AXI_ACE:NA;0|SD1:NonSecure;1|SD0:NonSecure;0|SATA1:NonSecure;1|SATA0:NonSecure;1|RPU1:Secure;1|RPU0:Secure;1|QSPI:NonSecure;1|PMU:NA;1|PCIe:NonSecure;1|NAND:NonSecure;0|LDMA:NonSecure;1|GPU:NonSecure;1|GEM3:NonSecure;0|GEM2:NonSecure;0|GEM1:NonSecure;0|GEM0:NonSecure;0|FDMA:NonSecure;1|DP:NonSecure;1|DAP:NA;1|Coresight:NA;1|CSU:NA;1|APU:NA;1} \
  ...
  connect_bd_intf_net -intf_net Conn3 [get_bd_intf_pins M05_AXI] [get_bd_intf_pins ps_axi_periph/M05_AXI]
  ...
  connect_bd_intf_net -intf_net axi_pl_ps_M00_AXI [get_bd_intf_pins axi_pl_ps/M00_AXI] [get_bd_intf_pins zynq_ultra_ps_e_0/S_AXI_HPC0_FPD]
  ...
  connect_bd_intf_net -intf_net zynq_ultra_ps_e_0_M_AXI_HPM0_FPD [get_bd_intf_pins ps_axi_periph/S00_AXI] [get_bd_intf_pins zynq_ultra_ps_e_0/M_AXI_HPM0_FPD]
  connect_bd_intf_net -intf_net zynq_ultra_ps_e_0_M_AXI_HPM1_FPD [get_bd_intf_pins bram/S00_AXI] [get_bd_intf_pins zynq_ultra_ps_e_0/M_AXI_HPM1_FPD]

  # Create port connections
  connect_bd_net -net ACLK_1 [get_bd_pins clk_75] [get_bd_pins axi_pl_ps/ACLK] [get_bd_pins axi_pl_ps/M00_ACLK] [get_bd_pins axi_pl_ps/S00_ACLK] [get_bd_pins axi_pl_ps/S01_ACLK] [get_bd_pins axi_pl_ps/S02_ACLK] [get_bd_pins bram/M00_ACLK] [get_bd_pins ps_axi_periph/ACLK] [get_bd_pins ps_axi_periph/M00_ACLK] [get_bd_pins ps_axi_periph/M01_ACLK] [get_bd_pins ps_axi_periph/M02_ACLK] [get_bd_pins ps_axi_periph/M03_ACLK] [get_bd_pins ps_axi_periph/M04_ACLK] [get_bd_pins ps_axi_periph/M05_ACLK] [get_bd_pins ps_axi_periph/S00_ACLK] [get_bd_pins ps_rst_75/slowest_sync_clk] [get_bd_pins zynq_ultra_ps_e_0/maxihpm0_fpd_aclk] [get_bd_pins zynq_ultra_ps_e_0/maxihpm1_fpd_aclk] [get_bd_pins zynq_ultra_ps_e_0/pl_clk0] [get_bd_pins zynq_ultra_ps_e_0/saxihpc0_fpd_aclk]
  ...
  connect_bd_net -net xlconstant_2_dout [get_bd_pins ps_rst_75/aux_reset_in] [get_bd_pins xlconstant_2/dout]
  connect_bd_net -net zynq_ultra_ps_e_0_pl_clk1 [get_bd_pins clk_50] [get_bd_pins zynq_ultra_ps_e_0/pl_clk1]
  connect_bd_net -net zynq_ultra_ps_e_0_pl_resetn0 [get_bd_pins ps_rst_75/ext_reset_in] [get_bd_pins zynq_ultra_ps_e_0/pl_resetn0]
...
proc create_hier_cell_other_perph { parentCell nameHier } {
  ...
  connect_bd_net -net tie_high_dout [get_bd_pins dout] [get_bd_pins tie_high/dout]

  # Restore current instance
  current_bd_instance $oldCurInst
}

# Hierarchical cell: axi_eth_fifo_ts
proc create_hier_cell_axi_eth_fifo_ts { parentCell nameHier } {

  variable script_folder

  if { $parentCell eq "" || $nameHier eq "" } {
     catch {common::send_msg_id "BD_TCL-102" "ERROR" "create_hier_cell_axi_eth_fifo_ts() - Empty argument(s)!"}
     return
  }
  ...
  create_bd_intf_pin -mode Slave -vlnv xilinx.com:interface:aximm_rtl:1.0 axi_rx_ts
  create_bd_intf_pin -mode Slave -vlnv xilinx.com:interface:aximm_rtl:1.0 axi_tx_ts
  create_bd_intf_pin -mode Slave -vlnv xilinx.com:interface:axis_rtl:1.0 axis_rx_ts

  # Create pins
  create_bd_pin -dir I -type clk ACLK
  create_bd_pin -dir I -from 0 -to 0 -type rst ARESETN
  create_bd_pin -dir I -type clk rx_mac_aclk
  create_bd_pin -dir I -type rst rx_reset
  create_bd_pin -dir O -type intr rxts_interrupt
  create_bd_pin -dir I -type clk s_axis_aclk
  create_bd_pin -dir I s_axis_tlast
  create_bd_pin -dir I -type clk tx_mac_aclk
  create_bd_pin -dir I -type rst tx_reset
  create_bd_pin -dir O -type intr txts_interrupt
  ...
  # Create instance: axis_rx_ts, and set properties
  set axis_rx_ts [ create_bd_cell -type ip -vlnv xilinx.com:ip:axis_interconnect:2.1 axis_rx_ts ]
  set_property -dict [ list \
   CONFIG.NUM_MI {1} \
 ] $axis_rx_ts

  # Create instance: fifo_rx_ts, and set properties
  set fifo_rx_ts [ create_bd_cell -type ip -vlnv xilinx.com:ip:axi_fifo_mm_s:4.1 fifo_rx_ts ]
  set_property -dict [ list \
   CONFIG.C_USE_TX_CTRL {0} \
   CONFIG.C_USE_TX_DATA {0} \
 ] $fifo_rx_ts

  # Create instance: fifo_tx_ts, and set properties
  set fifo_tx_ts [ create_bd_cell -type ip -vlnv xilinx.com:ip:axi_fifo_mm_s:4.1 fifo_tx_ts ]
  set_property -dict [ list \
  ...
  set rx_reset_n [ create_bd_cell -type ip -vlnv xilinx.com:ip:util_vector_logic:2.0 rx_reset_n ]
  set_property -dict [ list \
  ...
  set tx_reset_n [ create_bd_cell -type ip -vlnv xilinx.com:ip:util_vector_logic:2.0 tx_reset_n ]
  set_property -dict [ list \
   CONFIG.C_OPERATION {not} \
   CONFIG.C_SIZE {1} \
   CONFIG.LOGO_FILE {data/sym_notgate.png} \
  ...
  connect_bd_intf_net -intf_net axi_rx_ts_1 [get_bd_intf_pins axi_rx_ts] [get_bd_intf_pins fifo_rx_ts/S_AXI]
  connect_bd_intf_net -intf_net axi_tx_ts_1 [get_bd_intf_pins axi_tx_ts] [get_bd_intf_pins fifo_tx_ts/S_AXI]
  connect_bd_intf_net -intf_net axis_clock_converter_0_M_AXIS [get_bd_intf_pins axis_clock_converter_0/M_AXIS] [get_bd_intf_pins fifo_tx_ts/AXI_STR_RXD]
  ...
  connect_bd_intf_net -intf_net axis_rx_ts_1 [get_bd_intf_pins axis_rx_ts] [get_bd_intf_pins axis_rx_ts/S00_AXIS]
  connect_bd_intf_net -intf_net axis_rx_ts_M00_AXIS [get_bd_intf_pins axis_rx_ts/M00_AXIS] [get_bd_intf_pins fifo_rx_ts/AXI_STR_RXD]

  # Create port connections
  connect_bd_net -net ACLK_1 [get_bd_pins ACLK] [get_bd_pins axis_clock_converter_0/m_axis_aclk] [get_bd_pins axis_rx_ts/ACLK] [get_bd_pins axis_rx_ts/M00_AXIS_ACLK] [get_bd_pins fifo_rx_ts/s_axi_aclk] [get_bd_pins fifo_tx_ts/s_axi_aclk]
  connect_bd_net -net ARESETN_1 [get_bd_pins ARESETN] [get_bd_pins axis_clock_converter_0/m_axis_aresetn] [get_bd_pins axis_rx_ts/ARESETN] [get_bd_pins axis_rx_ts/M00_AXIS_ARESETN] [get_bd_pins fifo_rx_ts/s_axi_aresetn] [get_bd_pins fifo_tx_ts/s_axi_aresetn]
  connect_bd_net -net S00_AXIS_ARESETN_1 [get_bd_pins axis_rx_ts/S00_AXIS_ARESETN] [get_bd_pins rx_reset_n/Res]
  connect_bd_net -net fifo_rx_ts_interrupt [get_bd_pins rxts_interrupt] [get_bd_pins fifo_rx_ts/interrupt]
  connect_bd_net -net fifo_tx_ts_interrupt [get_bd_pins txts_interrupt] [get_bd_pins fifo_tx_ts/interrupt]
  connect_bd_net -net rx_mac_aclk_1 [get_bd_pins rx_mac_aclk] [get_bd_pins axis_rx_ts/S00_AXIS_ACLK]
  connect_bd_net -net rx_reset_1 [get_bd_pins rx_reset] [get_bd_pins rx_reset_n/Op1]
  connect_bd_net -net s_axis_tlast_1 [get_bd_pins s_axis_tlast] [get_bd_pins axis_dwidth_converter_0/s_axis_tlast]
  connect_bd_net -net tx_mac_aclk_1 [get_bd_pins tx_mac_aclk] [get_bd_pins axis_clock_converter_0/s_axis_aclk] [get_bd_pins axis_dwidth_converter_0/aclk]
  connect_bd_net -net tx_reset_1 [get_bd_pins tx_reset] [get_bd_pins tx_reset_n/Op1]
  connect_bd_net -net tx_reset_n_Res [get_bd_pins axis_clock_converter_0/s_axis_aresetn] [get_bd_pins axis_dwidth_converter_0/aresetn] [get_bd_pins tx_reset_n/Res]
...
proc create_root_design { parentCell } {
  ...
  set sys_timer [ create_bd_intf_port -mode Slave -vlnv xilinx.com:interface:diff_clock_rtl:1.0 sys_timer ]
  set_property -dict [ list \
 ...
 ] [get_bd_intf_pins /axi_eth_0/m_axis_tx_ts]

  set_property -dict [ list \
   CONFIG.TYPE {ETH_MGT_CLK} \
 ] [get_bd_intf_pins /axi_eth_0/mgt_clk]

  set_property -dict [ list \
   CONFIG.PROTOCOL {AXI4LITE} \
   CONFIG.ADDR_WIDTH {18} \
 ] [get_bd_intf_pins /axi_eth_0/s_axi]
 ...
 ] [get_bd_pins /axi_eth_0/gtref_clk_out]

  set_property -dict [ list \
   CONFIG.SENSITIVITY {LEVEL_HIGH} \
 ] [get_bd_pins /axi_eth_0/interrupt]
 ...
 ] [get_bd_pins /axi_eth_0/pma_reset_out]

  set_property -dict [ list \
   CONFIG.FREQ_HZ {62500000} \
 ] [get_bd_pins /axi_eth_0/rxuserclk2_out]

  set_property -dict [ list \
   CONFIG.FREQ_HZ {62500000} \
 ] [get_bd_pins /axi_eth_0/rxuserclk_out]
  ...
  set_property -dict [ list \
   CONFIG.FREQ_HZ {125000000} \
   CONFIG.ASSOCIATED_BUSIF {m_axis_tx_ts} \
 ] [get_bd_pins /axi_eth_0/tx_mac_aclk]

  set_property -dict [ list \
   CONFIG.FREQ_HZ {125000000} \
 ] [get_bd_pins /axi_eth_0/userclk2_out]

  set_property -dict [ list \
   CONFIG.FREQ_HZ {62500000} \
 ] [get_bd_pins /axi_eth_0/userclk_out]

  # Create instance: axi_eth_fifo_ts
  create_hier_cell_axi_eth_fifo_ts [current_bd_instance .] axi_eth_fifo_ts
  ...
  # Create instance: timer_1588_0, and set properties
  set timer_1588_0 [ create_bd_cell -type ip -vlnv xilinx.com:ip:timer_1588:2.0 timer_1588_0 ]
  set_property -dict [ list \
   CONFIG.TIMER_CLK_PERIOD {4000} \
 ] $timer_1588_0
 ...
 ] [get_bd_intf_pins /timer_1588_0/s_axi]
  ...
  # Create interface connections
  connect_bd_intf_net -intf_net CLK_IN_D_1 [get_bd_intf_ports sys_timer] [get_bd_intf_pins util_ds_buf_0/CLK_IN_D]
  connect_bd_intf_net -intf_net S01_AXI_1 [get_bd_intf_pins axi_dma_0/M_AXI_MM2S] [get_bd_intf_pins zynq_ps/S01_AXI]
  connect_bd_intf_net -intf_net S_AXI_1 [get_bd_intf_pins other_perph/S_AXI] [get_bd_intf_pins zynq_ps/M05_AXI]
  connect_bd_intf_net -intf_net axi_dma_0_M_AXIS_CNTRL [get_bd_intf_pins axi_dma_0/M_AXIS_CNTRL] [get_bd_intf_pins axi_eth_0/s_axis_txc]
  connect_bd_intf_net -intf_net axi_dma_0_M_AXIS_MM2S [get_bd_intf_pins axi_dma_0/M_AXIS_MM2S] [get_bd_intf_pins axi_eth_0/s_axis_txd]
  connect_bd_intf_net -intf_net axi_dma_0_M_AXI_S2MM [get_bd_intf_pins axi_dma_0/M_AXI_S2MM] [get_bd_intf_pins zynq_ps/S02_AXI]
  connect_bd_intf_net -intf_net axi_dma_0_M_AXI_SG [get_bd_intf_pins axi_dma_0/M_AXI_SG] [get_bd_intf_pins zynq_ps/S00_AXI]
  connect_bd_intf_net -intf_net axi_eth_0_m_axis_rxd [get_bd_intf_pins axi_dma_0/S_AXIS_S2MM] [get_bd_intf_pins axi_eth_0/m_axis_rxd]
  connect_bd_intf_net -intf_net axi_eth_0_m_axis_rxs [get_bd_intf_pins axi_dma_0/S_AXIS_STS] [get_bd_intf_pins axi_eth_0/m_axis_rxs]
  connect_bd_intf_net -intf_net axi_eth_0_m_axis_tx_ts [get_bd_intf_pins axi_eth_0/m_axis_tx_ts] [get_bd_intf_pins axi_eth_fifo_ts/S_AXIS]
  connect_bd_intf_net -intf_net axi_eth_0_sfp [get_bd_intf_ports sfp_rtl] [get_bd_intf_pins axi_eth_0/sfp]
  connect_bd_intf_net -intf_net axi_rx_ts_1 [get_bd_intf_pins axi_eth_fifo_ts/axi_rx_ts] [get_bd_intf_pins zynq_ps/M03_AXI]
  connect_bd_intf_net -intf_net axi_tx_ts_1 [get_bd_intf_pins axi_eth_fifo_ts/axi_tx_ts] [get_bd_intf_pins zynq_ps/M04_AXI]
  connect_bd_intf_net -intf_net mgt_clk_1 [get_bd_intf_ports mgt_clk] [get_bd_intf_pins axi_eth_0/mgt_clk]
  connect_bd_intf_net -intf_net zynq_ps_M00_AXI [get_bd_intf_pins timer_1588_0/s_axi] [get_bd_intf_pins zynq_ps/M00_AXI]
  connect_bd_intf_net -intf_net zynq_ps_M01_AXI [get_bd_intf_pins axi_dma_0/S_AXI_LITE] [get_bd_intf_pins zynq_ps/M01_AXI]
  connect_bd_intf_net -intf_net zynq_ps_M02_AXI [get_bd_intf_pins axi_eth_0/s_axi] [get_bd_intf_pins zynq_ps/M02_AXI]

  # Create port connections
  connect_bd_net -net In2_1 [get_bd_pins axi_eth_0/interrupt] [get_bd_pins zynq_ps/In0]
  connect_bd_net -net In7_1 [get_bd_pins axi_dma_0/s2mm_introut] [get_bd_pins zynq_ps/In6]
  connect_bd_net -net Net [get_bd_pins axi_eth_0/systemtimer_clk] [get_bd_pins timer_1588_0/systemtimer_clk] [get_bd_pins util_ds_buf_0/IBUF_OUT]
  connect_bd_net -net axi_dma_0_mm2s_cntrl_reset_out_n [get_bd_pins axi_dma_0/mm2s_cntrl_reset_out_n] [get_bd_pins axi_eth_0/axi_txc_arstn]
  connect_bd_net -net axi_dma_0_mm2s_introut [get_bd_pins axi_dma_0/mm2s_introut] [get_bd_pins zynq_ps/In5]
  connect_bd_net -net axi_dma_0_mm2s_prmry_reset_out_n [get_bd_pins axi_dma_0/mm2s_prmry_reset_out_n] [get_bd_pins axi_eth_0/axi_txd_arstn]
  connect_bd_net -net axi_dma_0_s2mm_prmry_reset_out_n [get_bd_pins axi_dma_0/s2mm_prmry_reset_out_n] [get_bd_pins axi_eth_0/axi_rxd_arstn]
  connect_bd_net -net axi_dma_0_s2mm_sts_reset_out_n [get_bd_pins axi_dma_0/s2mm_sts_reset_out_n] [get_bd_pins axi_eth_0/axi_rxs_arstn]
  connect_bd_net -net axi_eth_0_rxuserclk2_out [get_bd_pins axi_eth_0/rxuserclk2_out] [get_bd_pins other_perph/CLK]
  connect_bd_net -net axi_eth_0_userclk2_out [get_bd_pins axi_eth_0/userclk2_out] [get_bd_pins axi_eth_fifo_ts/s_axis_aclk] [get_bd_pins other_perph/CLK1]
  connect_bd_net -net axi_eth_fifo_ts_rxts_interrupt [get_bd_pins axi_eth_fifo_ts/rxts_interrupt] [get_bd_pins zynq_ps/In3]
  connect_bd_net -net axi_eth_fifo_ts_txts_interrupt [get_bd_pins axi_eth_fifo_ts/txts_interrupt] [get_bd_pins zynq_ps/In4]
  ...
  connect_bd_net -net other_perph_interrupt [get_bd_pins other_perph/interrupt] [get_bd_pins zynq_ps/In1]
  connect_bd_net -net s_axi_aclk_1 [get_bd_pins axi_dma_0/m_axi_mm2s_aclk] [get_bd_pins axi_dma_0/m_axi_s2mm_aclk] [get_bd_pins axi_dma_0/m_axi_sg_aclk] [get_bd_pins axi_dma_0/s_axi_lite_aclk] [get_bd_pins axi_eth_0/axis_clk] [get_bd_pins axi_eth_0/s_axi_lite_clk] [get_bd_pins axi_eth_fifo_ts/ACLK] [get_bd_pins axi_eth_fifo_ts/rx_mac_aclk] [get_bd_pins other_perph/s_axi_aclk] [get_bd_pins timer_1588_0/s_axi_aclk] [get_bd_pins zynq_ps/clk_75]
  connect_bd_net -net s_axi_aresetn_1 [get_bd_pins axi_dma_0/axi_resetn] [get_bd_pins axi_eth_0/s_axi_lite_resetn] [get_bd_pins axi_eth_fifo_ts/ARESETN] [get_bd_pins other_perph/s_axi_aresetn] [get_bd_pins proc_sys_reset_0/ext_reset_in] [get_bd_pins timer_1588_0/s_axi_resetn] [get_bd_pins zynq_ps/perph_aresetn_75]
  connect_bd_net -net timer_1588_0_interrupt [get_bd_pins timer_1588_0/interrupt] [get_bd_pins zynq_ps/In2]
  connect_bd_net -net timer_1588_0_systemtimer_ns_field [get_bd_pins axi_eth_0/systemtimer_ns_field] [get_bd_pins timer_1588_0/systemtimer_ns_field]
  connect_bd_net -net timer_1588_0_systemtimer_s_field [get_bd_pins axi_eth_0/systemtimer_s_field] [get_bd_pins timer_1588_0/systemtimer_s_field]
  connect_bd_net -net tx_mac_aclk_1 [get_bd_pins axi_eth_0/tx_mac_aclk] [get_bd_pins axi_eth_fifo_ts/tx_mac_aclk] [get_bd_pins proc_sys_reset_0/slowest_sync_clk]
  connect_bd_net -net tx_reset_2 [get_bd_pins axi_eth_fifo_ts/rx_reset] [get_bd_pins axi_eth_fifo_ts/tx_reset] [get_bd_pins proc_sys_reset_0/peripheral_reset]
  connect_bd_net -net xlconstant_0_dout [get_bd_pins axi_eth_0/signal_detect] [get_bd_pins xlconstant_0/dout]
  connect_bd_net -net xlconstant_1_dout [get_bd_pins axi_eth_fifo_ts/s_axis_tlast] [get_bd_pins xlconstant_1/dout]
  connect_bd_net -net zynq_ps_clk_50 [get_bd_pins axi_eth_0/ref_clk] [get_bd_pins zynq_ps/clk_50]

  # Create address segments
  create_bd_addr_seg -range 0x80000000 -offset 0x00000000 [get_bd_addr_spaces axi_dma_0/Data_SG] [get_bd_addr_segs zynq_ps/zynq_ultra_ps_e_0/SAXIGP0/HPC0_DDR_LOW] SEG_zynq_ultra_ps_e_0_HPC0_DDR_LOW
  create_bd_addr_seg -range 0x80000000 -offset 0x00000000 [get_bd_addr_spaces axi_dma_0/Data_MM2S] [get_bd_addr_segs zynq_ps/zynq_ultra_ps_e_0/SAXIGP0/HPC0_DDR_LOW] SEG_zynq_ultra_ps_e_0_HPC0_DDR_LOW
  create_bd_addr_seg -range 0x80000000 -offset 0x00000000 [get_bd_addr_spaces axi_dma_0/Data_S2MM] [get_bd_addr_segs zynq_ps/zynq_ultra_ps_e_0/SAXIGP0/HPC0_DDR_LOW] SEG_zynq_ultra_ps_e_0_HPC0_DDR_LOW
  create_bd_addr_seg -range 0x00001000 -offset 0xB0000000 [get_bd_addr_spaces zynq_ps/zynq_ultra_ps_e_0/Data] [get_bd_addr_segs zynq_ps/bram/axi_bram_ctrl_0/S_AXI/Mem0] SEG_axi_bram_ctrl_0_Mem0
  create_bd_addr_seg -range 0x00001000 -offset 0xA0040000 [get_bd_addr_spaces zynq_ps/zynq_ultra_ps_e_0/Data] [get_bd_addr_segs axi_dma_0/S_AXI_LITE/Reg] SEG_axi_dma_0_Reg
  create_bd_addr_seg -range 0x00040000 -offset 0xA0000000 [get_bd_addr_spaces zynq_ps/zynq_ultra_ps_e_0/Data] [get_bd_addr_segs axi_eth_0/s_axi/Reg0] SEG_axi_eth_0_Reg0
  create_bd_addr_seg -range 0x00001000 -offset 0xA0043000 [get_bd_addr_spaces zynq_ps/zynq_ultra_ps_e_0/Data] [get_bd_addr_segs other_perph/axi_timer_1/S_AXI/Reg] SEG_axi_timer_1_Reg
  create_bd_addr_seg -range 0x00001000 -offset 0xA0041000 [get_bd_addr_spaces zynq_ps/zynq_ultra_ps_e_0/Data] [get_bd_addr_segs axi_eth_fifo_ts/fifo_rx_ts/S_AXI/Mem0] SEG_fifo_rx_ts_Mem0
  create_bd_addr_seg -range 0x00001000 -offset 0xA0042000 [get_bd_addr_spaces zynq_ps/zynq_ultra_ps_e_0/Data] [get_bd_addr_segs axi_eth_fifo_ts/fifo_tx_ts/S_AXI/Mem0] SEG_fifo_tx_ts_Mem0
  create_bd_addr_seg -range 0x00010000 -offset 0xA0050000 [get_bd_addr_spaces zynq_ps/zynq_ultra_ps_e_0/Data] [get_bd_addr_segs timer_1588_0/s_axi/Reg] SEG_timer_1588_0_Reg

  # Exclude Address Segments
  create_bd_addr_seg -range 0x01000000 -offset 0xFF000000 [get_bd_addr_spaces axi_dma_0/Data_MM2S] [get_bd_addr_segs zynq_ps/zynq_ultra_ps_e_0/SAXIGP0/HPC0_LPS_OCM] SEG_zynq_ultra_ps_e_0_HPC0_LPS_OCM
  exclude_bd_addr_seg [get_bd_addr_segs axi_dma_0/Data_MM2S/SEG_zynq_ultra_ps_e_0_HPC0_LPS_OCM]

  create_bd_addr_seg -range 0x10000000 -offset 0xE0000000 [get_bd_addr_spaces axi_dma_0/Data_MM2S] [get_bd_addr_segs zynq_ps/zynq_ultra_ps_e_0/SAXIGP0/HPC0_PCIE_LOW] SEG_zynq_ultra_ps_e_0_HPC0_PCIE_LOW
  exclude_bd_addr_seg [get_bd_addr_segs axi_dma_0/Data_MM2S/SEG_zynq_ultra_ps_e_0_HPC0_PCIE_LOW]

  create_bd_addr_seg -range 0x20000000 -offset 0xC0000000 [get_bd_addr_spaces axi_dma_0/Data_MM2S] [get_bd_addr_segs zynq_ps/zynq_ultra_ps_e_0/SAXIGP0/HPC0_QSPI] SEG_zynq_ultra_ps_e_0_HPC0_QSPI
  exclude_bd_addr_seg [get_bd_addr_segs axi_dma_0/Data_MM2S/SEG_zynq_ultra_ps_e_0_HPC0_QSPI]

  create_bd_addr_seg -range 0x01000000 -offset 0xFF000000 [get_bd_addr_spaces axi_dma_0/Data_S2MM] [get_bd_addr_segs zynq_ps/zynq_ultra_ps_e_0/SAXIGP0/HPC0_LPS_OCM] SEG_zynq_ultra_ps_e_0_HPC0_LPS_OCM
  exclude_bd_addr_seg [get_bd_addr_segs axi_dma_0/Data_S2MM/SEG_zynq_ultra_ps_e_0_HPC0_LPS_OCM]

  create_bd_addr_seg -range 0x10000000 -offset 0xE0000000 [get_bd_addr_spaces axi_dma_0/Data_S2MM] [get_bd_addr_segs zynq_ps/zynq_ultra_ps_e_0/SAXIGP0/HPC0_PCIE_LOW] SEG_zynq_ultra_ps_e_0_HPC0_PCIE_LOW
  exclude_bd_addr_seg [get_bd_addr_segs axi_dma_0/Data_S2MM/SEG_zynq_ultra_ps_e_0_HPC0_PCIE_LOW]

  create_bd_addr_seg -range 0x20000000 -offset 0xC0000000 [get_bd_addr_spaces axi_dma_0/Data_S2MM] [get_bd_addr_segs zynq_ps/zynq_ultra_ps_e_0/SAXIGP0/HPC0_QSPI] SEG_zynq_ultra_ps_e_0_HPC0_QSPI
  exclude_bd_addr_seg [get_bd_addr_segs axi_dma_0/Data_S2MM/SEG_zynq_ultra_ps_e_0_HPC0_QSPI]

  create_bd_addr_seg -range 0x01000000 -offset 0xFF000000 [get_bd_addr_spaces axi_dma_0/Data_SG] [get_bd_addr_segs zynq_ps/zynq_ultra_ps_e_0/SAXIGP0/HPC0_LPS_OCM] SEG_zynq_ultra_ps_e_0_HPC0_LPS_OCM
  exclude_bd_addr_seg [get_bd_addr_segs axi_dma_0/Data_SG/SEG_zynq_ultra_ps_e_0_HPC0_LPS_OCM]

  create_bd_addr_seg -range 0x10000000 -offset 0xE0000000 [get_bd_addr_spaces axi_dma_0/Data_SG] [get_bd_addr_segs zynq_ps/zynq_ultra_ps_e_0/SAXIGP0/HPC0_PCIE_LOW] SEG_zynq_ultra_ps_e_0_HPC0_PCIE_LOW
  exclude_bd_addr_seg [get_bd_addr_segs axi_dma_0/Data_SG/SEG_zynq_ultra_ps_e_0_HPC0_PCIE_LOW]

  create_bd_addr_seg -range 0x20000000 -offset 0xC0000000 [get_bd_addr_spaces axi_dma_0/Data_SG] [get_bd_addr_segs zynq_ps/zynq_ultra_ps_e_0/SAXIGP0/HPC0_QSPI] SEG_zynq_ultra_ps_e_0_HPC0_QSPI
  exclude_bd_addr_seg [get_bd_addr_segs axi_dma_0/Data_SG/SEG_zynq_ultra_ps_e_0_HPC0_QSPI]
